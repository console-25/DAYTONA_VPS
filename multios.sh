...
echo -e "${CYAN}================================================================${NC}"
echo -e "${MAGENTA}       _____ _____ _____ _____ _____ _____ __ __       ${NC}"
echo -e "${MAGENTA}      |   __|_   _| __  |   __|   | |     |  |  |      ${NC}"
echo -e "${MAGENTA}      |__   | | | |    -|   __| | | |  |  |-   -|      ${NC}"
echo -e "${MAGENTA}      |_____| |_| |__|__|_____|_|___|_____|__|__|      ${NC}"
echo -e "${MAGENTA}                                                       ${NC}"
echo -e "${CYAN}================================================================${NC}"
echo -e "${YELLOW}           STRENOX | MULTI-OS DEPLOYMENT PANEL    ${NC}"
echo -e "${CYAN}================================================================${NC}"
echo ""
